...
//           {/*
//            ايقونات حتى بالواجهة الاساسية مامبينة
                ...
                <div className="col-xl-7 col-lg-8 col-md-12">
                  <div className="tp-cta__item-left">
                    <h3 className="tp-cta__title">
                      حوّل السلات المتروكة إلى مبيعات 🚀
                    </h3>
                    {/* <h3 className="tp-cta__title">{homeData.cta?.title}</h3> */}
                  </div>
                </div>
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="tp-platform__content pl-40">
                ...
                <p className="pb-25">
                  يمكنك الان إرسال إشعارات الطلبات والسلات المتروكة عبر واتساب
                  من خلال مرسل بكل سهولة وبشكل فوري خلال لحظات
                </p>
